...
export default function AddUpdateTaskModal({open, handleClose, handleAction, data = null, mode='add'}: AddUpdateTaskModalProps) {
  ...
  return (
      ...
      >
        <Stack sx={{...style, width: mode === "add" ? "674px" : "1026px" , height: '700px'}} >
            ...
            <Stack flexDirection="row" sx={{flex: 1}}>
                ...
                {mode === "update" && 
                    <Stack sx={{width: '355px'}}>
                        ...
                        <Stack sx={{flex: 1, bgcolor: 'background.paper'}}></Stack>
                    </Stack>
                }
            </Stack>
            ...
            <Stack flexDirection="row" 
                ...
                <Button disabled={false} onClick={handleCreate} sx={[styles.button, styles.buttonFilled]} >
